...
- “Numbers cannot be used in the middle of a plate; they must come at the end. For example, AAA222 would be an acceptable … vanity plate; AAA22A would not 
...
and False if it does not. Assume that s will be a str. You're welcome to implement ad
"""
